...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------>
	...
	<cffunction name="init" access="public" output="false" returntype="MockBox" hint="Create an instance of MockBox">
		...
		<cfscript>
			var tempDir =  "/mockbox/system/testing/stubs";
			...
			instance.mockGenerator 	= createObject("component","mockbox.system.testing.mockutils.MockGenerator").init(this);
...
<!------------------------------------------- PUBLIC ------------------------------------------>
	...
	<!--- Get Generator --->
	<cffunction name="getMockGenerator" access="public" returntype="mockbox.system.testing.mockutils.MockGenerator" output="false" hint="Get the Mock Generator Utility">
...
<!------------------------------------------- MOCK CREATION METHODS ------------------------------------------>
	...
	<cffunction name="createStub" output="false" access="public" returntype="any" hint="Create an empty stub object that you can use for mocking.">
		<cfargument name="callLogging" 	type="boolean" required="false" default="true" hint="Add method call logging for all mocked methods"/>
		<cfscript>
			return createMock(className="mockbox.system.testing.mockutils.Stub",callLogging=arguments.callLogging);
		</cfscript>
	</cffunction>	
