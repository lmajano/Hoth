...
----------------------------------------------------------------------->
<cfcomponent hint="This is the ColdBox Unit Test Front Controller." output="false" extends="mockbox.system.web.Controller">

<!------------------------------------------- PUBLIC ------------------------------------------->

	<cffunction name="init" returntype="mockbox.system.web.Controller" access="public" hint="Constructor" output="false">
		<cfargument name="appRootPath" type="string" required="true" hint="The app Root Path"/>
		<cfscript>
			super.init(argumentCollection=arguments);
			
			// Override mocks
			setRequestService( CreateObject("component","mockbox.system.testing.mock.services.MockRequestService").init(this) );
