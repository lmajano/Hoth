...
<cfcomponent output="false" hint="The main ColdBox utility library filled with lots of nice goodies.">
	...
	<!--- getMixerUtil --->
    <cffunction name="getMixerUtil" output="false" access="public" returntype="any" hint="Get the mixer utility" colddoc:generic="mockbox.system.core.dynamic.MixerUtil">
    	<cfscript>
    		if( structKeyExists(variables, "mixerUtil") ){ return variables.mixerUtil; }
			variables.mixerUtil = createObject("component","mockbox.system.core.dynamic.MixerUtil").init();
    ...
    <cffunction name="isFamilyType" output="false" access="public" returntype="boolean" hint="Checks if an object is of the passed in family type">
		...
		<cfscript>
			...
			switch(arguments.family){
				case "handler" 		: { familyPath = "mockbox.system.EventHandler"; break; }
				case "plugin" 		: { familyPath = "mockbox.system.Plugin"; break; }
				case "interceptor"  : { familyPath = "mockbox.system.Interceptor"; break; }
				default:{
